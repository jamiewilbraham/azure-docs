---
title: Cognitive Research Technologies and Machine Learning
titleSuffix: Azure Cognitive Research Technologies
description: Learn where Azure Cognitive Research Technologies fits in with other Azure offerings for machine learning.
...
ms.author: diberry
---
# Cognitive Research Technologies and machine learning

Cognitive Research Technologies provides machine learning capabilities to solve general problems such as analyzing text for emotional sentiment or analyzing images to recognize objects or faces. You don't need special machine learning or data science knowledge to use these services. 

[Cognitive Research Technologies](welcome.md) is a group of services, each supporting different, generalized prediction capabilities. The services are divided into different categories to help you find the right service. 
...
Use Cognitive Research Technologies when you:
...
## How are Cognitive Research Technologies and Azure Machine Learning (AML) similar?
...
* Cognitive Research Technologies are for developers without machine-learning experience.
...
Cognitive Research Technologies, as a group of services, can require none, some, or all custom data for the trained model. 
...
## Where can you use Cognitive Research Technologies?
...
## How is Azure Cognitive Search related to Cognitive Research Technologies?

[Azure Cognitive Search](../search/search-what-is-azure-search.md) is a separate cloud search service that optionally uses Cognitive Research Technologies to add image and natural language processing to indexing workloads. Cognitive Research Technologies is exposed in Azure Cognitive Search through [built-in skills](../search/cognitive-search-predefined-skills.md) that wrap individual APIs. You can use a free resource for walkthroughs, but plan on creating and attaching a [billable resource](../search/cognitive-search-attach-cognitive-services.md) for larger volumes.

## How can you use Cognitive Research Technologies?

Each service provides information about your data. You can combine services together to chain solutions such as converting speech (audio) to text, translating the text into many languages, then using the translated languages to get answers from a knowledge base. While Cognitive Research Technologies can be used to create intelligent solutions on their own, they can also be combined with traditional machine learning projects to supplement models or accelerate the development process. 

Cognitive Research Technologies that provide exported models for other machine learning tools:
