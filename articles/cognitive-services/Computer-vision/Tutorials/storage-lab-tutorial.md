...
1. Follow the instructions in [Create an Azure Cognitive Research Technologies resource](../../cognitive-services-apis-create-account.md) to create a Computer Vision resource.
