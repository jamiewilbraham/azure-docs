...
If you are using a Cognitive Research Technologies multi-service subscription, you must also include the `Ocp-Apim-Subscription-Region` in your request headers.
